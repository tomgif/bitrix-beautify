...
$MESS['USE_BACKURL_TIP'] = 'При наличии в адресной строке параметра <em>backurl</em> пользователь будет перенаправлен по указанной в этом параметре ссылке после заполнения формы регистрации.';
