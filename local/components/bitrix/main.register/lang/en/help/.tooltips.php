...
$MESS['USE_BACKURL_TIP'] = 'If a page URL contains the <strong>backurl</strong> parameter, a user will be redirected to this page upon registration.';
$MESS['SUCCESS_PAGE_TIP'] = 'Specifies a final page to which a user will be redirected upon successful registration.';
$MESS['SET_TITLE_TIP'] = 'Checking this option will set the page title to <strong>New User Registration</strong>.';
